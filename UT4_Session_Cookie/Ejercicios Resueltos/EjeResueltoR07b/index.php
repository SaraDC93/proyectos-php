...
if (!isset($_SESSION['usuario'])) {
    ...
    $stmt->bind_param('ss', $_SERVER['PHP_AUTH_USER'], $_SERVER['PHP_AUTH_PW']); //para asociar el parametro con el dato
    $stmt->execute(); //ejecutar en la BBDD la sentencia
...
<body>
<?php
if (!isset($dwes->connect_errno)) { //si no hay error al conectarse a la bbdd
